...
class Creator(RoutedAgent):
    ...
    El obtetivo lo orientaremos a fitness, deporte y socializacion
    Queremos que el Agente sea creativo y genere ideas de negocio innovadoras en estas verticales para liberar tiempo en tareas repetitivas.
    Requisito importante: que la clase debe ser llamada Agent, y debe heredar de RoutedAgent y tener un método __init__ que tome un parámetro de nombre.
